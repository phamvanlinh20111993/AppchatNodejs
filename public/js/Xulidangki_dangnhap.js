//nhac chuong chao mung den voi app
 //var audio = new Audio('/data/GaGay1.mp3');
 //audio.play();  
          ...
          success: function(data){
            if(data == "555"){//gui ve ma xac nhan khong duoc
              ...
              location.reload()
               ...
               var url = window.location.href.substring(Length - 10, Length)
          ...
          case 3:
            if(val.length < 6)  
              ...
              string = "Không để trống trường mật khẩu.";
               ...
               string = "Mat khau chi chua ki tu a-z, A-Z va so tu 0-9.";
            break;
